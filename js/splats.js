...
// const bucket = "http://localhost:8080";


// Function to list folders
async function listFolders() {
    const directories = [
        "ire_i2v", "car", "cauliflower_sheep", "download_(12)_0input", 
        "download_(14)_(2)_0input", "download_(47)_0input", "frog", "frog_2", 
        "ghost", "img_0_110", "lighthouse", "pig", "poly_fox", "teddybear_nyc_i2v", 
        "word_art_gen3d"
    ];
    return directories;
}
...
export async function setSplatScene(name, view) {
    ...
    // const splat = await SPLAT.PLYLoader.LoadAsync("/Users/mosamdabhi/research/Webpages/rat4d.github.io/splats/splat.ply", scene, (progress) => (view.progressIndicator.value = progress * 100));
...
// import { OrbitControls } from "./OrbitControls.js";
// import * as SPLAT from "https://cdn.jsdelivr.net/npm/gsplat@latest";
// const bucket = "http://localhost:8000/splats_assets";
